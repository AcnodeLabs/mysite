...
def scraper_login():
    ...
    base_url = 'www.prestoexperts.com'
    ...
    authentication_url = https_base_url + '/authentication/sign-in.aspx'

    # username and password for login
    username = 'three6tdegree@gmail.com'
    password = mykey('basepw')

    # we will use this string to confirm a login at end
    check_string = 'Hello Bilal'
    ...
    mark_start = '<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="'
    mark_end = '"'
